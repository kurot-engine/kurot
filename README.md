...
| [`@kurot/ui-runtime`](packages/ui-runtime/README.md)   | 0.5.5   | `packages/ui-runtime`  | Materializes semantic assets with transactional bindings, actions, transitions, resources, and component reuse | `core`, `ui`, `ui-document` |
