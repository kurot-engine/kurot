...
| [`@kurot/ui-document`](packages/ui-document/README.md) | 0.3.3   | `packages/ui-document` | Headless UI assets, appearance variants, validation, operations, transactions, revisions, diffs, and undo/redo | None                  |
| [`@kurot/ui-runtime`](packages/ui-runtime/README.md)   | 0.2.1   | `packages/ui-runtime`  | Materializes semantic assets and reusable components into real Kurot UI component trees                        | `core`, `ui`, `ui-document` |
