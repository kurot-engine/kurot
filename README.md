...
| [`@kurot/ui-document`](packages/ui-document/README.md) | 0.3.4   | `packages/ui-document` | Headless UI assets, appearance variants, validation, operations, transactions, revisions, diffs, and undo/redo | None                  |
