...
| `@kurot/ui-document` | 0.2.0 | Headless semantic UI asset model with reusable components, appearances, typed project references, and cross-document validation. No runtime dependencies.                    | [`packages/ui-document/docs/ai-context.md`](packages/ui-document/docs/ai-context.md) |
| `@kurot/ui-runtime` | 0.1.0 | Browser materializer for the format-v1 foundation document. It does not yet consume the format-v2 reusable asset model.                                                       | [`packages/ui-runtime/docs/ai-context.md`](packages/ui-runtime/docs/ai-context.md) |
