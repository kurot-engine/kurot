...
| `@kurot/ui-runtime` | 0.1.0 | Browser runtime that validates a `UIDocument` and materializes it into real `@kurot/ui` component instances.                                                                  | [`packages/ui-runtime/docs/ai-context.md`](packages/ui-runtime/docs/ai-context.md) |
