...
| `@kurot/ui-document` | 0.3.3 | Headless UI authoring kernel: semantic assets, reuse, appearance variants, validation, operations, transactions, revisions, diffs, and undo/redo. No runtime dependencies.   | [`packages/ui-document/docs/ai-context.md`](packages/ui-document/docs/ai-context.md) |
| `@kurot/ui-runtime` | 0.2.1 | Browser materializer for reuse, Slots, tokens, component variants/states, appearance variants/skins/states, and runtime adapters.                                           | [`packages/ui-runtime/docs/ai-context.md`](packages/ui-runtime/docs/ai-context.md) |
