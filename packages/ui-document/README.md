...
`kui.ProgressBar`, and `kui.TextInput` nodes. `Group` accepts ordered children;
the other concrete nodes are leaves.
...
properties of all eight concrete components. Unknown properties are rejected.
