...
```ts
import { Ease, Tween } from '@kurot/game';
...
```ts
import { MovieClip, MovieClipData } from '@kurot/game';
...
```ts
import { MovieClip, MovieClipDataFactory } from '@kurot/game';
...
```ts
import { Event, getTimer } from '@kurot/core';
...
```ts
import { MovieClipEvent } from '@kurot/game';
