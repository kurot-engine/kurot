import { EventDispatcher, DisplayObject, Event, type EventMap } from '@kurot/core';
...
export class Skin extends EventDispatcher<SkinEvents> {
	...
	/**
	 * Watchers attached while a skin is active. The runtime appends every
	 * {@link Watcher} instance created by the skin factory so they can
