...
export class ReportExporter {
	...
	public buildReport(sceneId: string, objectCount: number, stats: Stats): ReportData {
		return {
	...
	public formatMarkdown(report: ReportData): string {
		const header =
			'| Scene | Objects | FPS avg | FPS p95 | FPS max | Render avg (ms) | Render p95 (ms) | Render max (ms) | Draw Calls avg | Batch Efficiency |';
		const separator = '|---|---|---|---|---|---|---|---|---|---|';
